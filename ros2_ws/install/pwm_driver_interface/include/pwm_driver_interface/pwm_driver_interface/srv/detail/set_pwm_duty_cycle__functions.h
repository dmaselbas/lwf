...
#ifndef PWM_DRIVER_INTERFACE__SRV__DETAIL__SET_PWM_DUTY_CYCLE__FUNCTIONS_H_
#define PWM_DRIVER_INTERFACE__SRV__DETAIL__SET_PWM_DUTY_CYCLE__FUNCTIONS_H_
...
#include "pwm_driver_interface/msg/rosidl_generator_c__visibility_control.h"

#include "pwm_driver_interface/srv/detail/set_pwm_duty_cycle__struct.h"

/// Initialize srv/SetPwmDutyCycle message.
/**
...
/// Create srv/SetPwmDutyCycle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Request__init().
...
/// Destroy srv/SetPwmDutyCycle message.
/**
 * It calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Request__fini()
...
/// Check for srv/SetPwmDutyCycle message equality.
/**
...
/// Copy a srv/SetPwmDutyCycle message.
/**
...
/// Initialize array of srv/SetPwmDutyCycle messages.
/**
...
/// Finalize array of srv/SetPwmDutyCycle messages.
/**
 * It calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Request__fini()
...
/// Create array of srv/SetPwmDutyCycle messages.
/**
 * It allocates the memory for the array and calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetPwmDutyCycle messages.
/**
 * It calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetPwmDutyCycle message array equality.
/**
...
/// Copy an array of srv/SetPwmDutyCycle messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pwm_driver_interface
...
/**
 * It calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pwm_driver_interface
...
/**
 * It allocates the memory for the array and calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pwm_driver_interface
...
/**
 * It calls
 * pwm_driver_interface__srv__SetPwmDutyCycle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PWM_DRIVER_INTERFACE__SRV__DETAIL__SET_PWM_DUTY_CYCLE__FUNCTIONS_H_
