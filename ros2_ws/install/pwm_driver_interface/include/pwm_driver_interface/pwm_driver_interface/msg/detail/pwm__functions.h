...
#ifndef PWM_DRIVER_INTERFACE__MSG__DETAIL__PWM__FUNCTIONS_H_
#define PWM_DRIVER_INTERFACE__MSG__DETAIL__PWM__FUNCTIONS_H_
 ...
 * calls
 * pwm_driver_interface__msg__Pwm__init().
...
/**
 * It calls
 * pwm_driver_interface__msg__Pwm__fini()
 ...
 * pwm_driver_interface__msg__Pwm__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * pwm_driver_interface__msg__Pwm__Sequence__fini()
 * on the array,
...
#endif  // PWM_DRIVER_INTERFACE__MSG__DETAIL__PWM__FUNCTIONS_H_
