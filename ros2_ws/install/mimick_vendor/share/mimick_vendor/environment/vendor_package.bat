...
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\mimick_vendor\lib"
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\mimick_vendor\lib64"
