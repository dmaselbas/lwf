...
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\pybind11_vendor\lib"
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\pybind11_vendor\lib64"
