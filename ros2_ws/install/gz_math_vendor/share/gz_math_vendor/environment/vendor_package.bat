...
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_math_vendor\lib"
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_math_vendor\lib64"
